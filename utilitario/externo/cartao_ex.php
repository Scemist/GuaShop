<?php
  ...
  switch ($_POST['submit']) {
    case 'Cadastrar':
      $sql = $conexao -> prepare('INSERT INTO cartao(codigo_cart, numero_cart, nome_cart, vencimento_cart, nascimento_cart, id_usua)
      VALUES (:codigo, :numero, :proprietario, :vencimento, :nascimento, :usuario)');
    ...
    case 'Atualizar':
      $sql = $conexao -> prepare('UPDATE cartao
        SET codigo_cart = :codigo,
          numero_cart = :numero,
