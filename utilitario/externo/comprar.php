<?php
  ...
  // Cria o pedido
  $sql = $conexao -> prepare('INSERT INTO pedido (horario_pedi, data_pedi, endereco_pedi, formapagamento_pedi, estado_pedi, id_cart, id_usua) VALUES (:horario, :data, :endereco, :pagamento, :estado, :cartao, :usuario)');
