...
<body class="bg-light">
    <main class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-2 form-group mt-5">
                <a role="button" class="mx-2 btn btn-outline-primary w-100" href="externo/logout.php">Finalizar
                    Sessão</a>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="list-clean" role="tabpanel"
                        ...
                        <div class="tab-pane fade" id="list-<?= $control ?>" role="tabpanel"
                            ...
                            <?php } ?>
                            <a class="btn mt-3 btn-success float-right"
                                href="externo/pedido.php?func=processo&id=<?= $pedido['id_pedi'] ?>">Em processo</a>
                        </div>
                        <?php } ?>
                    </div>
                </div>
        ...
        <section class="bg-white rounded shadow p-4 my-4">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="list-clean2" role="tabpanel"
                            aria-labelledby="list-home-list">
                        ...
                        <div class="tab-pane fade" id="list-<?= $control ?>" role="tabpanel"
                            ...
                            <?php } ?>
                            <a class="btn mt-3 btn-warning float-right"
                                href="externo/pedido.php?func=entrega&id=<?= $pedido['id_pedi'] ?>">Em entrega</a>
                            <a class="btn mt-3 btn-sucess btn-sm mx-3 float-right"
                                href="externo/pedido.php?func=novo&id=<?= $pedido['id_pedi'] ?>">Voltar aos novos</a>
                        </div>
                        <?php } ?>
                    </div>
                </div>
        ...
        <section class="bg-white rounded shadow p-4 my-4">
			...
			?>
                ...
                <div class="col-8">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="list-clean3" role="tabpanel"
                            aria-labelledby="list-home-list">
                            <p class="lead">Aqui estão os pedidos esperando para entrega. Após a entrega de todos os
                                produtos do pedido serem feita, o pedido pode ser finalizado.</p>
                        </div>
                        <?php foreach ($pedidos as $controle => $pedido) {
			$sql = $conexao -> prepare('SELECT nome_prod, quantidade_item FROM item_pedido i JOIN produto p ON (i.id_prod = p.id_prod) WHERE i.id_pedi = :pedido AND p.id_loja = :loja');
			$sql -> bindParam(':pedido', $pedidos_id[$controle]);
			...
			?>
                        <div class="tab-pane fade" id="list-<?= $control ?>" role="tabpanel"
                            ...
                            <?php } ?>
                            <a class="btn mt-3 btn-primary float-right"
                                href="externo/pedido.php?func=finalizar&id=<?= $pedido['id_pedi'] ?>">Marcar como
                                finalizado</a>
                            <a class="btn mt-3 btn-sucess btn-sm mx-3 float-right"
                                href="externo/pedido.php?func=processo&id=<?= $pedido['id_pedi'] ?>">Voltar processo</a>
                        </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="col-3 p-1">
                <div class="bg-white rounded shadow-sm produto p-3 position-relative">
                    ...
                    <ul class="list-group lista w-100">
                        ...
                        <a class="list-group-item py-2 list-group-item-action active"
                            href="produto.php?id=<?=$coluna_id['id_prod']?>">Editar</a>
                    </ul>
                </div>
            </div>
